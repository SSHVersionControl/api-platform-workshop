...
class Form extends Component {
  ...
  render() {
    ...
    return <form onSubmit={handleSubmit}>
      <Field component={this.renderField} name="title" type="text" placeholder="The title of the news article" required={true}/>
      <Field component={this.renderField} name="body" type="text" placeholder="The body of the news article" required={true}/>
